...
public class Principal {
                                ...
                                switch (opcaoCliente){
                                    case 1:
                                        ...
                                        do{
                                            ...
                                            Produto p = Estoque.seekProduto(codigo);
                                            if(p != null){
                                                ...
                                                if(p instanceof ProdutoUnitario){              //instanceof é conhecido como operador de comparação de tipos, porque compara a instância com o tipo.
                                                    ...
                                                    verificacao = Estoque.produtoParaCompra(codigo, quantidade, true);
                                                    if(verificacao){
        ...
        private static void Saudacao() {
            Utilitario.ImprimaMensagem("*              Bem vindo ao Sistema de Supermercado             *");
            System.out.println("             Sistema desenvolvido por Vinicius e Danilo!");
            Utilitario.Continuar();
        }
        ...
        private static void CriarFuncionarios(){
            ...
            OperadorCaixa funcionario1 = new OperadorCaixa("Vinicius", "f1", "1111" );
            OperadorCaixa funcionario2 = new OperadorCaixa("Danilo", "f2", "1122"  );
            OperadorCaixa funcionario3 = new OperadorCaixa("Gabriel", "f3", "1133" );
            OperadorCaixa funcionario4 = new OperadorCaixa("Leander", "f4", "1144"  );
            OperadorCaixa funcionario5 = new OperadorCaixa("Bruno","f5", "1155" );
        ...
        private static void MenuGerenteRemoverProduto(Gerente gerente) {
            ...
            Produto p = Estoque.seekProduto(codigoProduto);
            if(p != null){
                boolean verificacao;
                if(p instanceof ProdutoUnitario){
                    ...
                    verificacao = Estoque.produtoParaCompra(codigoProduto, quantidade, false);
                    if(verificacao){
                        Estoque.removerProduto(codigoProduto, quantidade);
        ...
        private static void WizardAddProdutoUnidade(Gerente gerente) {
            ...
            Produto produtoEmEstoque = Estoque.seekProduto(codigoProduto);
